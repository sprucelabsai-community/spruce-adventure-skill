...
const broadcastTeamMessageEmitTargetAndPayloadSchema: SpruceSchemas.People.v2022_05_29.BroadcastTeamMessageEmitTargetAndPayloadSchema =
    {
        ...
        fields: {
            ...
            target: {
                ...
                isRequired: true,
                options: {
                    schema: broadcastTeamMessageEmitTargetSchema_v2022_05_29,
                },
            },
            /** . */
            payload: {
                ...
                isRequired: true,
                options: {
                    schema: broadcastTeamMessageEmitPayloadSchema_v2022_05_29,
                },
            },
        },
    }
...
SchemaRegistry.getInstance().trackSchema(
    broadcastTeamMessageEmitTargetAndPayloadSchema
)
