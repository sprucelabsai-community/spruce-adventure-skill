...
declare module '@sprucelabs/spruce-core-schemas/build/.spruce/schemas/core.schemas.types' {
	...
	namespace SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12 {
		...
		interface EventSourceSchema extends SpruceSchema.Schema {
			id: 'eventSource',
			version: 'v2021_08_12',
			namespace: 'HeartwoodTest1628806461547Count69',
			name: '',
			    fields: {
			            /** Proxy token. */
			            'proxyToken': {
		...
		type EventSourceEntity = SchemaEntity<SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.EventSourceSchema>
	...
	namespace SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12 {
		...
		interface TestRegisterSkillViews1628806460197EmitTarget {
			
				/** Update me. */
				'aTextField'?: string| undefined | null
		}

		interface TestRegisterSkillViews1628806460197EmitTargetSchema extends SpruceSchema.Schema {
			id: 'testRegisterSkillViews1628806460197EmitTarget',
			version: 'v2021_08_12',
			namespace: 'HeartwoodTest1628806461547Count69',
			name: '',
			    fields: {
		...
		type TestRegisterSkillViews1628806460197EmitTargetEntity = SchemaEntity<SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.TestRegisterSkillViews1628806460197EmitTargetSchema>
	...
	namespace SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12 {
		...
		interface TestRegisterSkillViews1628806460197EmitPayload {
			
				/** Update me. */
				'aTextField'?: string| undefined | null
		}

		interface TestRegisterSkillViews1628806460197EmitPayloadSchema extends SpruceSchema.Schema {
			id: 'testRegisterSkillViews1628806460197EmitPayload',
			version: 'v2021_08_12',
			namespace: 'HeartwoodTest1628806461547Count69',
			name: '',
			    fields: {
		...
		type TestRegisterSkillViews1628806460197EmitPayloadEntity = SchemaEntity<SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.TestRegisterSkillViews1628806460197EmitPayloadSchema>
	...
	namespace SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12 {
		...
		interface TestRegisterSkillViews1628806460197EmitTargetAndPayload {
			
				/** Source. */
				'source'?: SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.EventSource| undefined | null
				
				'target'?: SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.TestRegisterSkillViews1628806460197EmitTarget| undefined | null
				
				'payload'?: SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.TestRegisterSkillViews1628806460197EmitPayload| undefined | null
		}

		interface TestRegisterSkillViews1628806460197EmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			id: 'testRegisterSkillViews1628806460197EmitTargetAndPayload',
			version: 'v2021_08_12',
			namespace: 'HeartwoodTest1628806461547Count69',
			name: '',
			    fields: {
			            ...
			            'source': {
			                label: 'Source',
			                type: 'schema',
			                options: {schema: SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.EventSourceSchema,}
			            },
			            /** . */
			            'target': {
			                type: 'schema',
			                options: {schema: SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.TestRegisterSkillViews1628806460197EmitTargetSchema,}
			            },
			            /** . */
			            'payload': {
			                type: 'schema',
			                options: {schema: SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.TestRegisterSkillViews1628806460197EmitPayloadSchema,}
			            },
			    }
		}

		type TestRegisterSkillViews1628806460197EmitTargetAndPayloadEntity = SchemaEntity<SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.TestRegisterSkillViews1628806460197EmitTargetAndPayloadSchema>
	...
	namespace SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12 {
		...
		interface TestRegisterSkillViews1628806460197ResponsePayload {
			
				/** Update me. */
				'aTextField'?: string| undefined | null
		}

		interface TestRegisterSkillViews1628806460197ResponsePayloadSchema extends SpruceSchema.Schema {
			id: 'testRegisterSkillViews1628806460197ResponsePayload',
			version: 'v2021_08_12',
			namespace: 'HeartwoodTest1628806461547Count69',
			name: '',
			    fields: {
		...
		type TestRegisterSkillViews1628806460197ResponsePayloadEntity = SchemaEntity<SpruceSchemas.HeartwoodTest1628806461547Count69.v2021_08_12.TestRegisterSkillViews1628806460197ResponsePayloadSchema>
