...
import aTempSkill1633466885863Count2TestSyncEventContract_v2021_01_01, {
	TestSyncEventContract as ATempSkill1633466885863Count2TestSyncEventContract_v2021_01_01,
} from '#spruce/events/aTempSkill1633466885863Count2/testSync.v2021_01_01.contract'
...
import eventStoreTestSkill1633466976468Count28MyEventStoreAmazingEventEventContract_v2021_10_05, {
	MyEventStoreAmazingEventEventContract as EventStoreTestSkill1633466976468Count28MyEventStoreAmazingEventEventContract_v2021_10_05,
} from '#spruce/events/eventStoreTestSkill1633466976468Count28/myEventStoreAmazingEvent.v2021_10_05.contract'
import eventStoreTestSkill1633467014429Count29MyEventStoreAmazingEventEventContract_v2021_10_05, {
	MyEventStoreAmazingEventEventContract as EventStoreTestSkill1633467014429Count29MyEventStoreAmazingEventEventContract_v2021_10_05,
} from '#spruce/events/eventStoreTestSkill1633467014429Count29/myEventStoreAmazingEvent.v2021_10_05.contract'
...
import heartwoodTest1633467101152Count29TestEventEventContract_v2020_01_01, {
	TestEventEventContract as HeartwoodTest1633467101152Count29TestEventEventContract_v2020_01_01,
} from '#spruce/events/heartwoodTest1633467101152Count29/testEvent.v2020_01_01.contract'
import heartwoodTest1633467211240Count49TestRegisterSkillViews1633467209749EventContract_v2021_10_05, {
	TestRegisterSkillViews1633467209749EventContract as HeartwoodTest1633467211240Count49TestRegisterSkillViews1633467209749EventContract_v2021_10_05,
} from '#spruce/events/heartwoodTest1633467211240Count49/testRegisterSkillViews1633467209749.v2021_10_05.contract'
import mySecondSkill1633466877532Count79MyNewEventEventContract_v2021_10_05, {
	MyNewEventEventContract as MySecondSkill1633466877532Count79MyNewEventEventContract_v2021_10_05,
} from '#spruce/events/mySecondSkill1633466877532Count79/myNewEvent.v2021_10_05.contract'
import mySkill16334605759581566MyCoolEventEventContract_v2021_01_22, {
	MyCoolEventEventContract as MySkill16334605759581566MyCoolEventEventContract_v2021_01_22,
} from '#spruce/events/mySkill16334605759581566/myCoolEvent.v2021_01_22.contract'
...
export default [
	...
	mySecondSkill1633466877532Count79MyNewEventEventContract_v2021_10_05,
	aTempSkill1633466885863Count2TestSyncEventContract_v2021_01_01,
	eventStoreTestSkill1633466976468Count28MyEventStoreAmazingEventEventContract_v2021_10_05,
	eventStoreTestSkill1633467014429Count29MyEventStoreAmazingEventEventContract_v2021_10_05,
	heartwoodTest1633467101152Count29TestEventEventContract_v2020_01_01,
	heartwoodTest1633467211240Count49TestRegisterSkillViews1633467209749EventContract_v2021_10_05,
...
declare module '@sprucelabs/mercury-types/build/types/mercury.types' {
	interface SkillEventSignatures {
		...
		'my-second-skill-1633466877532-count-79.my-new-event::v2021_10_05': MySecondSkill1633466877532Count79MyNewEventEventContract_v2021_10_05['eventSignatures']['my-second-skill-1633466877532-count-79.my-new-event::v2021_10_05']

		'a-temp-skill-1633466885863-count-2.test-sync::v2021_01_01': ATempSkill1633466885863Count2TestSyncEventContract_v2021_01_01['eventSignatures']['a-temp-skill-1633466885863-count-2.test-sync::v2021_01_01']

		'event-store-test-skill-1633466976468-count-28.my-event-store-amazing-event::v2021_10_05': EventStoreTestSkill1633466976468Count28MyEventStoreAmazingEventEventContract_v2021_10_05['eventSignatures']['event-store-test-skill-1633466976468-count-28.my-event-store-amazing-event::v2021_10_05']

		'event-store-test-skill-1633467014429-count-29.my-event-store-amazing-event::v2021_10_05': EventStoreTestSkill1633467014429Count29MyEventStoreAmazingEventEventContract_v2021_10_05['eventSignatures']['event-store-test-skill-1633467014429-count-29.my-event-store-amazing-event::v2021_10_05']

		'heartwood-test-1633467101152-count-29.test-event::v2020_01_01': HeartwoodTest1633467101152Count29TestEventEventContract_v2020_01_01['eventSignatures']['heartwood-test-1633467101152-count-29.test-event::v2020_01_01']

		'heartwood-test-1633467211240-count-49.test-register-skill-views1633467209749::v2021_10_05': HeartwoodTest1633467211240Count49TestRegisterSkillViews1633467209749EventContract_v2021_10_05['eventSignatures']['heartwood-test-1633467211240-count-49.test-register-skill-views1633467209749::v2021_10_05']
