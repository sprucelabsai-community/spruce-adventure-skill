...
import aTempSkill1632755139515Count100TestSyncEventContract_v2021_01_01, {
	TestSyncEventContract as ATempSkill1632755139515Count100TestSyncEventContract_v2021_01_01,
} from '#spruce/events/aTempSkill1632755139515Count100/testSync.v2021_01_01.contract'
...
import eventStoreTestSkill1632755196365Count93MyEventStoreAmazingEventEventContract_v2021_09_27, {
	MyEventStoreAmazingEventEventContract as EventStoreTestSkill1632755196365Count93MyEventStoreAmazingEventEventContract_v2021_09_27,
} from '#spruce/events/eventStoreTestSkill1632755196365Count93/myEventStoreAmazingEvent.v2021_09_27.contract'
import eventStoreTestSkill1632755236987Count94MyEventStoreAmazingEventEventContract_v2021_09_27, {
	MyEventStoreAmazingEventEventContract as EventStoreTestSkill1632755236987Count94MyEventStoreAmazingEventEventContract_v2021_09_27,
} from '#spruce/events/eventStoreTestSkill1632755236987Count94/myEventStoreAmazingEvent.v2021_09_27.contract'
...
import heartwoodTest1632755254011Count94TestEventEventContract_v2020_01_01, {
	TestEventEventContract as HeartwoodTest1632755254011Count94TestEventEventContract_v2020_01_01,
} from '#spruce/events/heartwoodTest1632755254011Count94/testEvent.v2020_01_01.contract'
import heartwoodTest1632755399909Count6TestRegisterSkillViews1632755397985EventContract_v2021_09_27, {
	TestRegisterSkillViews1632755397985EventContract as HeartwoodTest1632755399909Count6TestRegisterSkillViews1632755397985EventContract_v2021_09_27,
} from '#spruce/events/heartwoodTest1632755399909Count6/testRegisterSkillViews1632755397985.v2021_09_27.contract'
import mySecondSkill1632755082561Count87MyNewEventEventContract_v2021_09_27, { MyNewEventEventContract as MySecondSkill1632755082561Count87MyNewEventEventContract_v2021_09_27  } from '#spruce/events/mySecondSkill1632755082561Count87/myNewEvent.v2021_09_27.contract'
...
export default [
	...
	mySecondSkill1632755082561Count87MyNewEventEventContract_v2021_09_27,
	mySkill16327551258311577MyCoolEventEventContract_v2021_01_22,
	aTempSkill1632755139515Count100TestSyncEventContract_v2021_01_01,
	eventStoreTestSkill1632755196365Count93MyEventStoreAmazingEventEventContract_v2021_09_27,
	heartwoodTest1632755254011Count94TestEventEventContract_v2020_01_01,
	eventStoreTestSkill1632755236987Count94MyEventStoreAmazingEventEventContract_v2021_09_27,
	heartwoodTest1632755399909Count6TestRegisterSkillViews1632755397985EventContract_v2021_09_27,
...
declare module '@sprucelabs/mercury-types/build/types/mercury.types' {
	interface SkillEventSignatures {
		...
		'my-second-skill-1632755082561-count-87.my-new-event::v2021_09_27': MySecondSkill1632755082561Count87MyNewEventEventContract_v2021_09_27['eventSignatures']['my-second-skill-1632755082561-count-87.my-new-event::v2021_09_27']
		...
		'a-temp-skill-1632755139515-count-100.test-sync::v2021_01_01': ATempSkill1632755139515Count100TestSyncEventContract_v2021_01_01['eventSignatures']['a-temp-skill-1632755139515-count-100.test-sync::v2021_01_01']

		'event-store-test-skill-1632755196365-count-93.my-event-store-amazing-event::v2021_09_27': EventStoreTestSkill1632755196365Count93MyEventStoreAmazingEventEventContract_v2021_09_27['eventSignatures']['event-store-test-skill-1632755196365-count-93.my-event-store-amazing-event::v2021_09_27']

		'heartwood-test-1632755254011-count-94.test-event::v2020_01_01': HeartwoodTest1632755254011Count94TestEventEventContract_v2020_01_01['eventSignatures']['heartwood-test-1632755254011-count-94.test-event::v2020_01_01']

		'event-store-test-skill-1632755236987-count-94.my-event-store-amazing-event::v2021_09_27': EventStoreTestSkill1632755236987Count94MyEventStoreAmazingEventEventContract_v2021_09_27['eventSignatures']['event-store-test-skill-1632755236987-count-94.my-event-store-amazing-event::v2021_09_27']

		'heartwood-test-1632755399909-count-6.test-register-skill-views1632755397985::v2021_09_27': HeartwoodTest1632755399909Count6TestRegisterSkillViews1632755397985EventContract_v2021_09_27['eventSignatures']['heartwood-test-1632755399909-count-6.test-register-skill-views1632755397985::v2021_09_27']
