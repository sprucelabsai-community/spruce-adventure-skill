...
import aTempSkill1633654112619Count4TestSyncEventContract_v2021_01_01, {
	TestSyncEventContract as ATempSkill1633654112619Count4TestSyncEventContract_v2021_01_01,
} from '#spruce/events/aTempSkill1633654112619Count4/testSync.v2021_01_01.contract'
...
import eventStoreTestSkill1633654182084Count36MyEventStoreAmazingEventEventContract_v2021_10_08, {
	MyEventStoreAmazingEventEventContract as EventStoreTestSkill1633654182084Count36MyEventStoreAmazingEventEventContract_v2021_10_08,
} from '#spruce/events/eventStoreTestSkill1633654182084Count36/myEventStoreAmazingEvent.v2021_10_08.contract'
import eventStoreTestSkill1633654217556Count37MyEventStoreAmazingEventEventContract_v2021_10_08, {
	MyEventStoreAmazingEventEventContract as EventStoreTestSkill1633654217556Count37MyEventStoreAmazingEventEventContract_v2021_10_08,
} from '#spruce/events/eventStoreTestSkill1633654217556Count37/myEventStoreAmazingEvent.v2021_10_08.contract'
...
import heartwoodTest1633654588706Count28TestEventEventContract_v2020_01_01, {
	TestEventEventContract as HeartwoodTest1633654588706Count28TestEventEventContract_v2020_01_01,
} from '#spruce/events/heartwoodTest1633654588706Count28/testEvent.v2020_01_01.contract'
import heartwoodTest1633654629189Count84TestRegisterSkillViews1633654627242EventContract_v2021_10_08, {
	TestRegisterSkillViews1633654627242EventContract as HeartwoodTest1633654629189Count84TestRegisterSkillViews1633654627242EventContract_v2021_10_08,
} from '#spruce/events/heartwoodTest1633654629189Count84/testRegisterSkillViews1633654627242.v2021_10_08.contract'
import mySecondSkill1633654189109Count45MyNewEventEventContract_v2021_10_08, { MyNewEventEventContract as MySecondSkill1633654189109Count45MyNewEventEventContract_v2021_10_08  } from '#spruce/events/mySecondSkill1633654189109Count45/myNewEvent.v2021_10_08.contract'
import mySkill16336187753921614MyCoolEventEventContract_v2021_01_22, { MyCoolEventEventContract as MySkill16336187753921614MyCoolEventEventContract_v2021_01_22  } from '#spruce/events/mySkill16336187753921614/myCoolEvent.v2021_01_22.contract'
import mySkill16336405819001615MyCoolEventEventContract_v2021_01_22, { MyCoolEventEventContract as MySkill16336405819001615MyCoolEventEventContract_v2021_01_22  } from '#spruce/events/mySkill16336405819001615/myCoolEvent.v2021_01_22.contract'
import mySkill16336514513841581MyCoolEventEventContract_v2021_01_22, { MyCoolEventEventContract as MySkill16336514513841581MyCoolEventEventContract_v2021_01_22  } from '#spruce/events/mySkill16336514513841581/myCoolEvent.v2021_01_22.contract'
import mySkill16336621751001610MyCoolEventEventContract_v2021_01_22, {
	MyCoolEventEventContract as MySkill16336621751001610MyCoolEventEventContract_v2021_01_22,
} from '#spruce/events/mySkill16336621751001610/myCoolEvent.v2021_01_22.contract'
...
export default [
	...
	mySkill16336187753921614MyCoolEventEventContract_v2021_01_22,
	mySkill16336405819001615MyCoolEventEventContract_v2021_01_22,
	mySkill16336514513841581MyCoolEventEventContract_v2021_01_22,
	aTempSkill1633654112619Count4TestSyncEventContract_v2021_01_01,
	mySecondSkill1633654189109Count45MyNewEventEventContract_v2021_10_08,
	eventStoreTestSkill1633654182084Count36MyEventStoreAmazingEventEventContract_v2021_10_08,
	eventStoreTestSkill1633654217556Count37MyEventStoreAmazingEventEventContract_v2021_10_08,
	heartwoodTest1633654588706Count28TestEventEventContract_v2020_01_01,
	heartwoodTest1633654629189Count84TestRegisterSkillViews1633654627242EventContract_v2021_10_08,
	mySkill16336621751001610MyCoolEventEventContract_v2021_01_22,
...
declare module '@sprucelabs/mercury-types/build/types/mercury.types' {
	interface SkillEventSignatures {
		...
		'my-skill-1633618775392-1614.my-cool-event::v2021_01_22': MySkill16336187753921614MyCoolEventEventContract_v2021_01_22['eventSignatures']['my-skill-1633618775392-1614.my-cool-event::v2021_01_22']

		'my-skill-1633640581900-1615.my-cool-event::v2021_01_22': MySkill16336405819001615MyCoolEventEventContract_v2021_01_22['eventSignatures']['my-skill-1633640581900-1615.my-cool-event::v2021_01_22']

		'my-skill-1633651451384-1581.my-cool-event::v2021_01_22': MySkill16336514513841581MyCoolEventEventContract_v2021_01_22['eventSignatures']['my-skill-1633651451384-1581.my-cool-event::v2021_01_22']

		'a-temp-skill-1633654112619-count-4.test-sync::v2021_01_01': ATempSkill1633654112619Count4TestSyncEventContract_v2021_01_01['eventSignatures']['a-temp-skill-1633654112619-count-4.test-sync::v2021_01_01']

		'my-second-skill-1633654189109-count-45.my-new-event::v2021_10_08': MySecondSkill1633654189109Count45MyNewEventEventContract_v2021_10_08['eventSignatures']['my-second-skill-1633654189109-count-45.my-new-event::v2021_10_08']

		'event-store-test-skill-1633654182084-count-36.my-event-store-amazing-event::v2021_10_08': EventStoreTestSkill1633654182084Count36MyEventStoreAmazingEventEventContract_v2021_10_08['eventSignatures']['event-store-test-skill-1633654182084-count-36.my-event-store-amazing-event::v2021_10_08']

		'event-store-test-skill-1633654217556-count-37.my-event-store-amazing-event::v2021_10_08': EventStoreTestSkill1633654217556Count37MyEventStoreAmazingEventEventContract_v2021_10_08['eventSignatures']['event-store-test-skill-1633654217556-count-37.my-event-store-amazing-event::v2021_10_08']

		'heartwood-test-1633654588706-count-28.test-event::v2020_01_01': HeartwoodTest1633654588706Count28TestEventEventContract_v2020_01_01['eventSignatures']['heartwood-test-1633654588706-count-28.test-event::v2020_01_01']

		'heartwood-test-1633654629189-count-84.test-register-skill-views1633654627242::v2021_10_08': HeartwoodTest1633654629189Count84TestRegisterSkillViews1633654627242EventContract_v2021_10_08['eventSignatures']['heartwood-test-1633654629189-count-84.test-register-skill-views1633654627242::v2021_10_08']

		'my-skill-1633662175100-1610.my-cool-event::v2021_01_22': MySkill16336621751001610MyCoolEventEventContract_v2021_01_22['eventSignatures']['my-skill-1633662175100-1610.my-cool-event::v2021_01_22']
