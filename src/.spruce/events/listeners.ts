...
const listeners: EventFeatureListener[] = [
    {
        ...
        version: 'v2022_09_24',
        callback: require('../../listeners/skill/did-boot.v2022_09_24.listener')
            .default,
        isGlobal: require('../../listeners/skill/did-boot.v2022_09_24.listener')
            .isGlobal,
    },
    {
        eventName: 'will-boot',
        ...
        version: 'v2021_08_03',
        callback:
            require('../../listeners/skill/will-boot.v2021_08_03.listener')
                .default,
        isGlobal:
            require('../../listeners/skill/will-boot.v2021_08_03.listener')
                .isGlobal,
    },
    {
        ...
        version: 'v2022_09_09',
        callback:
            require('../../friends/listeners/adventure/accept-connection.v2022_09_09.listener')
                .default,
        isGlobal:
            require('../../friends/listeners/adventure/accept-connection.v2022_09_09.listener')
                .isGlobal,
    },
    {
        ...
        version: 'v2022_09_09',
        callback:
            require('../../friends/listeners/adventure/create-connection.v2022_09_09.listener')
                .default,
        isGlobal:
            require('../../friends/listeners/adventure/create-connection.v2022_09_09.listener')
                .isGlobal,
