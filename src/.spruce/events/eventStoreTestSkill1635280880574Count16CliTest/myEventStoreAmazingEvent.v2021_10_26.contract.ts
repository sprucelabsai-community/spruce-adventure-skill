...
import myEventStoreAmazingEventEmitTargetAndPayloadSchema from '#spruce/schemas/eventStoreTestSkill1635280893888Count17CliTest/v2021_10_26/myEventStoreAmazingEventEmitTargetAndPayload.schema'
import myEventStoreAmazingEventResponsePayloadSchema from '#spruce/schemas/eventStoreTestSkill1635280893888Count17CliTest/v2021_10_26/myEventStoreAmazingEventResponsePayload.schema'

const myEventStoreAmazingEventEventContract = buildEventContract({
	eventSignatures: {
		'event-store-test-skill-1635280880574-count-16-cli-test.my-event-store-amazing-event::v2021_10_26':
			{
				isGlobal: true,
