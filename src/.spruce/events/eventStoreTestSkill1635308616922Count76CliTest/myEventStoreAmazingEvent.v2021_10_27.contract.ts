...
import myEventStoreAmazingEventEmitTargetAndPayloadSchema from '#spruce/schemas/eventStoreTestSkill1635308629068Count77CliTest/v2021_10_27/myEventStoreAmazingEventEmitTargetAndPayload.schema'
import myEventStoreAmazingEventResponsePayloadSchema from '#spruce/schemas/eventStoreTestSkill1635308629068Count77CliTest/v2021_10_27/myEventStoreAmazingEventResponsePayload.schema'

const myEventStoreAmazingEventEventContract = buildEventContract({
	eventSignatures: {
		'event-store-test-skill-1635308616922-count-76-cli-test.my-event-store-amazing-event::v2021_10_27':
			{
				isGlobal: true,
